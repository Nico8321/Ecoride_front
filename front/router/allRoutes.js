...
export const allRoutes = [
  ...
  new Route("/publier", "Connexion", "/pages/publier.html", ["user"], "/js/publier.js"),
  new Route("/monCompte", "Mon Compte", "/pages/monCompte.html", ["user"], "/js/monCompte.js"),
  new Route("/modifierMotDePasse", "Modification du mot de passe", "/pages/modifierMotDePasse.html", ["user"], "/js/contact.js"),
